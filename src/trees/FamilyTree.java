...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		String childrenString = line.substring(colonIndex + 1); //he substring of line that starts just after colonIndex and goes through the end of
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException("Not in file");
			}
		}
